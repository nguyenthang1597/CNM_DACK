...
import { faHome, faBell, faEnvelope, faUser, faSignOutAlt } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className='topbar'>
      <div className='topbar_content'>
        <div className='tabs'>
          ...
          <div className={`tab ${tab === 'msg' ? 'active' : null}`} onClick={() => { props.history.push('/message'); setTab('msg'); }}><FontAwesomeIcon icon={faEnvelope} style={{ marginRight: 5 }} />Tin nhắn</div>
        </div>
